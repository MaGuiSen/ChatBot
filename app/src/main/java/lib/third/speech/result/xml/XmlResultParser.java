 ...
 * 
 */
package lib.third.speech.result.xml;

import android.text.TextUtils;
import android.util.Xml;

import lib.third.speech.result.FinalResult;
import lib.third.speech.result.ReadSentenceResult;
import lib.third.speech.result.ReadSyllableResult;
import lib.third.speech.result.ReadWordResult;
import lib.third.speech.result.Result;
import lib.third.speech.result.entity.Phone;
import lib.third.speech.result.entity.Sentence;
import lib.third.speech.result.entity.Syll;
import lib.third.speech.result.entity.Word;
